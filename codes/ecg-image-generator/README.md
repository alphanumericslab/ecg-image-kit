...
- `--mask_unplotted_samples`: Mask the samples not plotted in the images in the generated WFDB signal file; default: False. For example: The non-plotted samples will be in the range $\in$ [2.5, 10] seconds for the 4x3 format. 
